...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // 2. Real-Time Telemetry & Clocks (Aspen Style)
  function updateClocks() {
    const now = new Date();
    
    const nycEl = document.getElementById('clock-nyc');
    if (nycEl) {
      nycEl.textContent = new Intl.DateTimeFormat('en-US', {
    ...
    if (laEl) {
      laEl.textContent = new Intl.DateTimeFormat('en-US', {
    ...
    if (utcEl) {
      utcEl.textContent = new Intl.DateTimeFormat('en-US', {
        timeZone: 'UTC',
        hour: '2-digit',
        minute: '2-digit',
        second: '2-digit',
